...
Helpful: `GEND_F`, `TRPDUR`, `INCOM`, `TRNCT`

A little helpful: `PARKC`, `PARKU_H`, `PARKU_D`, `PARKU_W`, and `PARKU_M`

Really not helpful:`AGE`, `TOLL`, 


In summary, these models suggest that the gender of a driver, the duration of their trip, their income, and the cost of using transit are the most important predictors of whether they will drive alone to work. These findings seem reasonable. In the U.S., women still share an unequal burden of childcare compared to men. Additionally, the gender pay gap could be a factor, since income appears to be a significant predictor of driving alone as well.

The cost of parking, and whether they pay hourly, daily, weekly, or monthly are of secondary importance. It is not surprising that these supply-side factors 

Finally, these models suggest that the age of a drive and the presence of a toll are of relatively little significance to whether or not they will drive alone.
