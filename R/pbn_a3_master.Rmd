...
Crucially, we are trying to determine which of these independent variables have the most predictive relevance.
...
```
Comparing the models with a stargazer table helps us see that the AIC increase of 90 is comparatively slight, and worth the trade off of a model that has solely significant variables.
